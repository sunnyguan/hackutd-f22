            ...
            <div className={"flex items-center justify-center mb-3"}>
                {
                    ...
                    <>
                    <button 
                        className={"bg-white hover:bg-sky-300 text-gray-800 font-semibold py-4 px-7 border border-sky-300 rounded shadow hover:shadow-lg mx-5"}
                        onClick={() => setVisibleItem("signup")}
                    >
                        Get Started
                    </button>
                    <button 
                        className={"bg-white hover:bg-sky-300 text-gray-800 font-semibold py-4 px-7 border border-sky-300 rounded shadow hover:shadow-lg m-8"}
